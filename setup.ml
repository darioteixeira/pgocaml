...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7d5819db9efc474766f8fdf190eb7cbe) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["PGOCaml"; "PGOCaml_generic"];
                      lib_pack = false;
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some ">\248\132\241:b\202M\007\222\205\167\161\021\0241";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
