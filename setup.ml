...
(* OASIS_START *)
(* DO NOT EDIT (digest: b422bc087f2f10c218ef1be572506393) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("ppx_tools_versioned.metaquot_407", None);
     ...
     oasis_digest = Some "\005W\1341\147\163,\185\183\209}\016B\198\138\147";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
